...
The following table shows the domains and the percentage of scored questions in each domain for the CLF-C01 exam (in use until September 18, 2023) and the CLF-C02 exam (in use beginning on September 19, 2023).
